...
public class DemoNoSQLTableFactory {
    ...
    DemoNoSQLTableFactory(final Context context) {
        ...
        supportedTablesList.add(new DemoNoSQLTableUserProfile());
        supportedTablesList.add(new DemoNoSQLTableConversation());
        supportedTablesList.add(new DemoNoSQLTableChatRoom());
